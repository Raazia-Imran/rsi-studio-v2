      ...
      <div className="w-full mt-10 flex justify-center overflow-x-auto overflow-y-hidden px-4 no-scrollbar">
        <div className="relative min-w-[1200px] h-[800px] z-10 flex items-center justify-center">
          ...
          <svg className="absolute inset-0 w-full h-full pointer-events-none z-0">
            <defs>
              <linearGradient id="coralFlow" x1="0%" y1="0%" x2="100%" y2="100%">
            ...
            <g stroke="url(#coralFlow)" strokeWidth="2" fill="none" filter="url(#coreGlow)">
              {[
                ...
                <motion.path
                  ...
                  transition={{ duration: 4, delay: line.delay, repeat: Infinity, ease: "easeInOut" }}
                />
              ))}
            </g>
          </svg>
          ...
          <div className="absolute top-[40px] left-[80px] w-[340px] h-[240px] rounded-2xl bg-[#0D0D12] border border-white/10 p-5 flex flex-col shadow-2xl z-20">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-[13px] font-bold text-white uppercase tracking-wider">Web Design</h3>
            </div>
          ...
          <div className="absolute top-[40px] left-[430px] w-[340px] h-[240px] rounded-2xl bg-[#0D0D12] border border-white/10 p-5 flex flex-col shadow-2xl z-20">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-[13px] font-bold text-white uppercase tracking-wider">Web Development</h3>
            </div>
            <div className="w-full h-[90px] bg-[#111] rounded-lg border border-white/5 relative overflow-hidden mb-4 flex items-center px-4 gap-4">
               <div className="relative w-14 h-14 flex items-center justify-center">
                  <svg className="w-full h-full transform -rotate-90">
                    ...
                    <motion.circle cx="28" cy="28" r="24" stroke="#FF6B6B" strokeWidth="4" fill="none" strokeDasharray="150" animate={{ strokeDashoffset: [150, 0, 0] }} transition={{ duration: 3, repeat: Infinity, ease: "easeInOut" }} />
                  </svg>
                  <span className="absolute text-[10px] font-bold text-white">100</span>
               </div>
               <div className="flex-1 flex flex-col gap-2">
          ...
          <div className="absolute top-[40px] left-[780px] w-[340px] h-[240px] rounded-2xl bg-[#0D0D12] border border-white/10 p-5 flex flex-col shadow-2xl z-20">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-[13px] font-bold text-white uppercase tracking-wider">Custom Software</h3>
            </div>
            <div className="w-full h-[90px] bg-[#111] rounded-lg border border-white/5 relative overflow-hidden mb-4 flex items-center justify-center gap-6">
               <div className="w-8 h-8 rounded-md border border-white/10 flex items-center justify-center bg-white/5 z-10"><Cpu size={12} className="text-white/40" /></div>
               <div className="w-10 h-10 rounded-md border border-[#FF6B6B]/40 flex items-center justify-center bg-[#FF6B6B]/10 shadow-[0_0_15px_rgba(255,107,107,0.2)] z-10"><Code2 size={14} className="text-[#FF6B6B]" /></div>
               <div className="w-8 h-8 rounded-md border border-white/10 flex items-center justify-center bg-white/5 z-10"><Cpu size={12} className="text-white/40" /></div>
               ...
               <div className="absolute left-16 right-16 h-[1px] bg-transparent top-1/2 -translate-y-1/2 z-0 overflow-hidden">
                 <motion.div animate={{ x: ["-100%", "200%"] }} transition={{ duration: 1.5, repeat: Infinity, ease: "linear" }} className="w-1/3 h-full bg-[#FF6B6B] shadow-[0_0_8px_#FF6B6B]" />
               </div>
            </div>
            <p className="text-xs text-white/50 font-medium leading-relaxed">
          ...
          <div className="absolute top-[520px] left-[80px] w-[340px] h-[240px] rounded-2xl bg-[#0D0D12] border border-white/10 p-5 flex flex-col shadow-2xl z-20">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-[13px] font-bold text-white uppercase tracking-wider">Blogging</h3>
            </div>
          ...
          <div className="absolute top-[520px] left-[430px] w-[340px] h-[240px] rounded-2xl bg-[#0D0D12] border border-white/10 p-5 flex flex-col shadow-2xl z-20">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-[13px] font-bold text-white uppercase tracking-wider">Monthly Presence</h3>
            </div>
            <div className="w-full h-[90px] bg-[#111] rounded-lg border border-white/5 relative overflow-hidden mb-4 flex items-center justify-center p-2">
               <svg className="w-full h-full" preserveAspectRatio="none" viewBox="0 0 100 40">
                 ...
                 <motion.path 
                   ...
                   transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
                   style={{ filter: "drop-shadow(0px 0px 4px rgba(255,107,107,0.5))" }}
                 />
               </svg>
            </div>
            <p className="text-xs text-white/50 font-medium leading-relaxed">
          ...
          <div className="absolute top-[520px] left-[780px] w-[340px] h-[240px] rounded-2xl bg-[#0D0D12] border border-white/10 p-5 flex flex-col shadow-2xl z-20">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-[13px] font-bold text-white uppercase tracking-wider">Web Automations</h3>
            </div>
            <div className="w-full h-[90px] bg-[#111] rounded-lg border border-white/5 relative overflow-hidden mb-4 p-3 flex flex-col justify-center gap-3">
               {[
                 ...
                 <div key={i} className="flex items-center gap-3">
                    <div className="w-4 h-4 rounded bg-white/5 flex items-center justify-center border border-white/10"><Bot size={8} className="text-white/40" /></div>
