...
export default function Footer() {
  return (
    <footer className="relative bg-[#050505] text-white overflow-hidden pt-32">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        {/* ===== Premium DesignMonks Marquee Layer ===== */}
        <div className="mb-24">
          <h4 className="text-center text-xs font-mono text-white/30 uppercase tracking-[0.3em] mb-16">
            Trusted By Global Industry Leaders
          </h4>
          ...
          >
            {PARTNERS.map((item, i) => (
              <div key={i} className="flex flex-col items-center mx-12">
                <img
                  src={item.logo}
                  alt={`${item.name} Logo`}
                  className="w-16 h-16 md:w-20 md:h-20 object-contain grayscale opacity-60 hover:grayscale-0 hover:opacity-100 transition-all duration-500 mb-2"
                  onError={(e) => (e.currentTarget.style.display = "none")}
                />
                <div className="text-sm font-semibold whitespace-nowrap">
                  {item.name}
                </div>
                <p className="text-gray-500 text-[9px] uppercase tracking-widest whitespace-nowrap">
                  {item.sub}
                </p>
              </div>
            ))}
        ...
        {/* ===== Legal & Copyright ===== */}
        <div className="flex flex-col md:flex-row justify-between items-center text-center mt-24 pt-8 border-t border-white/10 mb-12">
          <div className="flex gap-8 text-[10px] tracking-[0.2em] uppercase text-white/40 mb-4 md:mb-0">
            <a href="#" className="hover:text-white transition-colors">
              Terms & Conditions
            </a>
      ...
      {/* ===== Eman's Massive RSI Studio Branding ===== */}
      <div className="relative h-[180px] md:h-[220px] lg:h-[260px] overflow-hidden flex justify-center items-end pointer-events-none">
        {/* Coral Pink Glow Layers */}
        <div className="absolute bottom-0 w-[90%] h-36 blur-3xl bg-[#FF6B6B]/30 rounded-full"></div>
        <div className="absolute bottom-6 w-[70%] h-28 blur-2xl bg-[#FF6B6B]/20 rounded-full"></div>
        <div className="absolute bottom-10 w-[50%] h-20 blur-xl bg-[#FF6B6B]/10 rounded-full"></div>

        {/* RSI Studio Text */}
        <h1 className="relative font-display font-bold uppercase tracking-tighter text-white select-none text-[clamp(4rem,12vw,10rem)] leading-none translate-y-8">
          RSI Studio
        </h1>
      </div>
    </footer>
