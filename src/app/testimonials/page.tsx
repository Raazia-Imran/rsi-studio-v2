...
function InstagramSlide() {
  ...
  return (
    <div className="flex flex-col gap-4 w-full max-w-[480px]">
      <p
        className={`${spaceMono.className} text-[9px] tracking-[0.3em] uppercase text-[#FF6B6B]`}
      >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
        {cards.map((c, i) => (
          <div
            key={i}
            className="bg-[#111] rounded-sm p-3 hover:-translate-y-1 transition-all duration-300 cursor-pointer"
            style={{ border: `1px solid ${c.color}22` }}
          >
            <div
              className="w-8 h-8 rounded-full mb-2 flex items-center justify-center text-[8px] font-bold"
              style={{
                background: `radial-gradient(circle at 35% 35%, ${c.color}, ${c.color}55)`,
                color: "#000",
            ...
            <p
              className={`${spaceMono.className} text-[8px] tracking-widest uppercase mb-1`}
              style={{ color: c.color }}
            >
              {c.label}
            </p>
            <div
              className={`${spaceMono.className} flex justify-between text-[7px] text-white/30 mb-2`}
            >
    ...
    <div className="flex flex-col gap-6 w-full max-w-[420px]">
      {items.map((item, i) => (
        <div key={i} className="flex flex-col gap-2">
          <div
            className={`${spaceMono.className} flex justify-between text-[10px] uppercase tracking-widest`}
          >
    ...
    <div className="w-full max-w-[460px]">
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-px bg-white/[0.04]">
        {clients.map((c, i) => (
          <div
            key={i}
            className="aspect-[1.6] flex flex-col items-center justify-center gap-1 transition-all duration-300 cursor-default group"
            style={{ background: "#0d0d0d" }}
          >
            <div
              className="w-8 h-8 rounded-full flex items-center justify-center text-[10px] font-bold mb-1 transition-all duration-300 group-hover:scale-110"
              style={{
            ...
            <span
              className={`${spaceMono.className} text-[9px] tracking-[0.15em] uppercase`}
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-px w-full max-w-[440px] bg-white/[0.04]">
      {stats.map((s, i) => (
        <div
          key={i}
          className="p-5 md:p-8 flex flex-col gap-2 group cursor-default"
          style={{ background: "#0d0d0d" }}
        >
          <span
            className={`${cormorant.className} text-5xl font-light leading-none`}
            style={{ color: s.color, textShadow: `0 0 24px ${s.color}44` }}
          >
            {s.num}
          </span>
          <span
            className={`${spaceMono.className} text-[9px] tracking-[0.25em] uppercase text-white/30`}
          >
            {s.label}
          </span>
          <div
            className="h-px w-8 mt-1 rounded-full"
...
function PortfolioSection() {
  ...
  const prev = () =>
    goTo(
      (current - 1 + portfolioSlides.length) % portfolioSlides.length,
      "left",
    );
    ...
    <section className="w-full bg-[#050505] border-y border-white/10 flex flex-col md:flex-row min-h-[500px] md:min-h-[600px]">
      ...
      <div className="w-full md:w-[36%] flex items-center px-6 md:px-12 py-10 md:py-0 shrink-0 border-b md:border-b-0 md:border-r border-white/[0.06]">
        <div className="flex items-center gap-5">
          <span className="text-[#FF6B6B] text-3xl leading-none select-none">
            →
          </span>
          <h2
            className={`${cormorant.className} text-[clamp(36px,5vw,80px)] font-light leading-none tracking-tight text-white`}
          >
            Portfolio
          </h2>
        </div>
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center pl-6 md:pl-24 pr-6 md:pr-12 py-8 md:py-10 overflow-hidden">
          <div className="w-full flex flex-col items-center">
            <p
              className={`${spaceMono.className} text-[9px] tracking-[0.3em] uppercase text-white/20 mb-6`}
            >
              {slide.title}
            </p>
            <div
              className={`w-full transition-all duration-300 ease-in-out ${isAnim ? exitClass : enterClass}`}
            >
        ...
        {/* Bottom nav bar */}
        <div
          className={`${spaceMono.className} border-t border-white/[0.06] px-4 md:px-8 py-4 flex items-center gap-3 md:gap-5`}
        >
          <button
            onClick={prev}
            aria-label="Previous"
            className="text-white/40 hover:text-white transition-colors duration-200 text-base w-5 text-center"
          >
            ‹
          </button>
          ...
          <div className="flex-1 h-px bg-white/[0.08] relative overflow-hidden">
            <div
              className="absolute left-0 top-0 h-full bg-[#FF6B6B] transition-all duration-500 ease-out"
              style={{
                width: `${((current + 1) / portfolioSlides.length) * 100}%`,
              }}
            />
          </div>
          ...
          <button className="text-white/25 hover:text-white/60 transition-colors text-sm tracking-widest">
            ···
          </button>
        </div>
      </div>
    ...
    >
      ...
      <div
        style={{
          ...
          paddingBottom: "214%",
          boxShadow:
            "0 8px 40px rgba(0,0,0,0.15), inset 0 0 0 1px rgba(255,255,255,0.04)",
        }}
      >
        <div
          style={{
          ...
          {imageSrc ? (
            ...
            <div
              style={{
                width: "100%",
                height: "100%",
                background: "linear-gradient(to bottom, #141414, #090909)",
                display: "flex",
                flexDirection: "column",
                alignItems: "center",
                justifyContent: "center",
    ...
    <div style={{ overflow: "hidden", width: "100%", padding: "10px 0" }}>
      <div
        style={{
          display: "flex",
          width: "max-content",
          animation: `${dir === "left" ? "tagL" : "tagR"} ${speed}s linear infinite`,
        }}
      >
        {[...tags, ...tags, ...tags].map((tag, i) => (
          <span
            ...
            style={{
              ...
              padding: "0 16px",
              color: tag === "•" ? "#FF6B6B" : "rgba(0,0,0,0.35)",
              fontWeight: 700,
            }}
          >
            {tag}
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2
          className="text-3xl md:text-5xl lg:text-6xl font-display font-bold tracking-tighter"
      ...
      >
        <div
          style={{
            display: "flex",
            width: "max-content",
            animation: "deviceScroll 50s linear infinite",
            animationPlayState: paused ? "paused" : "running",
          }}
        >
          {[0, 1, 2].map((copy) =>
            SCENES.map((scene, i) => (
              <DeviceScene key={`${copy}-${i}`} scene={scene} />
            )),
          )}
        </div>
      </div>
    ...
    <main className="bg-[#050505] min-h-screen pt-32 pb-40 overflow-hidden text-white selection:bg-[#FF6B6B] selection:text-black">
      ...
      <section className="relative w-full py-16 md:py-32 bg-[#080808] border-y border-white/10 flex flex-col gap-8 overflow-hidden">
        ...
        <div className="container mx-auto px-6 mb-8 relative z-20">
          ...
          <h2 className="text-3xl md:text-5xl lg:text-6xl font-display font-bold tracking-tighter text-white">
            THE <span className="text-white/30">CONSENSUS</span>
          </h2>
        </div>
        <PuzzleStrip
